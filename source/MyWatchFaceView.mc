...
class MyWatchFaceView extends WatchUi.WatchFace {
    ...
    function onUpdate(dc as Dc) as Void {
        ...
        // Draw clock hands
        // dynamic shading based on light source location
        ClockHandRendererDynamicShading.drawClockHandByType(dc, centerX, centerY, ClockHandRendererDynamicShading.HAND_HOUR, clockTime.hour, clockTime.min, radius);
        ClockHandRendererDynamicShading.drawClockHandByType(dc, centerX, centerY, ClockHandRendererDynamicShading.HAND_MINUTE, clockTime.min, 0, radius);
        ClockHandRendererDynamicShading.drawClockHandByType(dc, centerX, centerY, ClockHandRendererDynamicShading.HAND_SECOND, clockTime.sec, 0, radius);

        // shade one side of the hand, regardless of light source
        // ClockHandRendererStaticShading.drawHourHand(dc, centerX, centerY, clockTime.hour, clockTime.min, radius);
        // ClockHandRendererStaticShading.drawMinuteHand(dc, centerX, centerY, clockTime.min, radius);
        // ClockHandRendererStaticShading.drawSecondHand(dc, centerX, centerY, clockTime.sec, radius);
